  ...
  const partners = [
    {
      ...
      name: 'UniCesumar',
      category: 'education',
      logo: 'https://i.ibb.co/fz3vzRMB/unicesumar.jpg',
...

    {
      ...
      name: 'Instituto IESP',
      category: 'education',
      logo: 'https://i.ibb.co/3mW0HDxG/instituto-IESP.jpg',
...

    {
      ...
      category: 'health',
      logo: 'https://i.ibb.co/QjTFLzn9/academia-hardcore.jpg',
      benefits: [
...

    {
      ...
      name: 'Star Kids',
      category: 'entertainment',
      logo: 'https://i.ibb.co/Y7fn4qgd/star-kids.jpg',
    ...
    { 
      ...
      name: 'Multi Peças',
      category: 'automotive', 
      logo: 'https://i.ibb.co/DDfgkcjf/multi-pe-as.jpg',
      benefits: [
    ...
    { 
      ...
      logo: 'https://i.ibb.co/LD8VsDft/dormit-rio-s-ant-nio.png',
    ...
    { 
      ...
      name: 'Espaço Prime',
      category: 'entertainment', 
      logo: 'https://i.ibb.co/XfdGDY96/espa-o-prime.jpg',
    ...
    { 
      ...
      name: 'Bella Store',
      category: 'shopping', 
      logo: 'https://i.ibb.co/k68D9jQ2/bella-store.jpg',
    ...
    { 
      id: 12,
      name: 'Raízes Naturalle',
      category: 'health', 
      logo: 'https://i.ibb.co/vv4TBnBB/raizes-naturalle.jpg',
      benefits: '**15% de desconto** em produtos naturais de beleza e bem-estar + **frete grátis** para Pedreiras.',
      instagram: 'https://www.instagram.com/raizes.naturalle',
      whatsapp: 'https://api.whatsapp.com/send/?phone=5599985307832',
      address: 'Av. Abílio Monteiro, Nº 1359B - Centro, Pedreiras - MA (ao lado da Recar-Tur)'
    },
    { 
      id: 13,
      name: 'Recar-Tur',
      ...
      address: 'Av. Abílio Monteiro, Nº 1359 - Engenho, Pedreiras - MA'
    },
    { 
      id: 14,
      name: 'Prime Barbearia',
      category: 'services', 
      logo: 'https://i.ibb.co/6Rg6cwqK/prime-barbearia.jpg',
      benefits: [
        '**Corte de cabelo**: de R$30 por R$25.',
        '**Barba simples**: gratuita junto ao corte (válido para ajustes leves, como aparar pelos ou bigode).',
      ...
      whatsapp: [
        'https://api.whatsapp.com/send/?phone=5599988233050',
        'https://api.whatsapp.com/send/?phone=5599981817026'
      ],
      address: 'R. Pinto Saldanha, N°69A - Centro, Pedreiras - MA'
    },
    { 
      id: 15,
...
return (
  <div className="min-h-screen relative overflow-hidden">
    ...
    <div className="fixed inset-0">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-zinc-950/50 to-black/80"></div>
    </div>
